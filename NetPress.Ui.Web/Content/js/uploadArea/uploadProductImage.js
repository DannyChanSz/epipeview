$(document).ready(function () {
    ...
    $("#Uploader").pluploadQueue({
        ...
        //url: 'ProductUploadHandler.ashx',
        //url: '/ImageUploadHandler.ashx',
        url: '/Areas/UploadArea/Ashx/ImageUploadHandler.ashx',
        //url: '../ImageUploadHandler',
        //url: 'Upload',
        //url: '/UploadArea/Ashx/IISHandler1',

        max_file_size: '2mb',
        chunk_size: '64kb',
        unique_names: false,
        // Resize images on clientside if we can
        resize: { width: 1920, height: 1920, quality: 90 },//前端裁切
    ...
    //uploader.bind("FileUploaded", function (upload, file, response) {//上传图片callback方法
